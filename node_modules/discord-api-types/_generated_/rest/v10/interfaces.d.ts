...
export interface RoutesDeclarations {
     ...
     */
    guildMessagesSearch(guildId: Snowflake): `/guilds/${string}/messages/search`;
    /**
     * Route for:
     ...
     */
    applicationActivityInstance(applicationId: Snowflake, instanceId: string): `/applications/${string}/activity-instances/${string}`;
    /**
     * Route for:
